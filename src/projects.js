...
//
                  { "title": "A choropleth map", 
                    "tagline": "Percentage of adults age 25 and older with a bachelor's degree or higher (2010-2014)",
                    "description": "",
                    "features": [ "Visualize data and color map accordingly"],
...
//
                  { "title": "Pomodoro Clock", 
                    "tagline": "The Pomodoro Clock is a stopwatch, designed to split your work time into managable junks. It was part of the Front End Challenges from freecodecamp.com.",
                    "description": "M Project Goals",
                    "features": [ "Customize countdown timer in intevals of one minute with the + / - buttons.",
                                      "Upon reaching zero, this clock will give you an alert sound, even when running in the background.",
                                      "Only a stopwatch, nothing else.",
                                      "My Feature description 4"],
                    "images": [ "pomodoro.png",
                                "placeholder.jpg",
                                "placeholder.jpg"],
                    "link": "https://attiimaster.github.io/pomodoro-clock",
                    "tech": ["Front-End", "jQuery", "Javascript", "Bootstrap"]}, 
//
                  { "title": "Wiki Viewer", 
                    "tagline": "The Wikiviewer is an app, that let's you search wikipedia. It was part of the Front End Challenges from freecodecamp.com.",
                    "description": "M Project Goals",
                    "features": [ "My Feature description 1",
                                      "My Feature description 2",
                                      "My Feature description 3",
                                      "My Feature description 4"],
                    "images": [ "wikiViewer.png",
                                "placeholder.jpg",
                                "placeholder.jpg"],
                    "link": "https://codepen.io/AttiiMasteR/full/PEeYxM/",
                    "tech": ["Front-End", "jQuery", "Javascript", "Bootstrap"]},
//
                  { "title": "Tic Tac Toe", 
                    "tagline": "Tic Tac Toe - a classic game, built only with Javascript. Pick X or O and play a round vs the AI. This was part of the Front End Challenges from freecodecamp.com.",
                    "description": "M Project Goals",
                    "features": [ "An AI opponent that really makes for a challenge.",
                                      "Choose whether to play as X's or O's.",
                                      "Choose between Normal Mode and Hard Mode, which let's you try your luck against the unbeatable AI.",
                                      "My Feature description 4"],
                    "images": [ "tictactoe.png",
                                "placeholder.jpg",
                                "placeholder.jpg"],
                    "link": "https://attiimaster.github.io/tic-tac-toe",
                    "tech": ["Front-End", "jQuery", "Javascript", "Bootstrap"]},
//
                  { "title": "A Javascript Calculator", 
                    "tagline": "A modern web calculator with some handy features.",
                    "description": "M Project Goals",
                    "features": [ "Not too sure",
                                      "Basic conversions for miles, yards, foot and many more.",
                                      "Every operation you enter is saved so you don't have to remember every step.",
                                      "Room for more complex math operations."],
                    "images": [ "js-calculator.png",
                                "placeholder.jpg",
                                "placeholder.jpg"],
                    "link": "https://attiimaster.github.io/js-calculator",
                    "tech": ["Front-End", "jQuery", "Javascript", "Bootstrap"]}];
//

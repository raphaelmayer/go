		...
		return(
        	<div className="overlay" style={ visible ? { transform: "translateX(0)", opacity: 1, visibility: "visible" } : null }>
        		...
        		<div className="overlay-text-box">
                    <h2>{ p.title } {p.repo && <a href={ p.repo } target="_blank" rel="noopener noreferrer"></a>}</h2>
                    <p><em>{ p.tagline }</em></p>
                    <h3>Main Features</h3>
                    ...
                    <a href={ p.repo } target="_blank" rel="noopener noreferrer"><button className="overlay-btn">View repository</button></a>
                </div>

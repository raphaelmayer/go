  ...
  return( 
      <div> 
        <div className="services-text-box">
          ...
          <p>In my time as a software developer building and maintaining a diverse set of applications I encountered a wide variety of problems and hence I am confident I can add value to your project and help you throughout your development process from conceptualizing prototypes to deploying a finished product.</p>
